...
Live: **https://baditaflorin.github.io/mesh-class-checkin/**

Source: **https://github.com/baditaflorin/mesh-class-checkin**
...
git clone https://github.com/baditaflorin/mesh-class-checkin
cd mesh-class-checkin
npm install
npm run dev
```
...
- `mesh-class-checkin:signalingUrl`
- `mesh-class-checkin:turnTokenUrl`
- `mesh-class-checkin:iceServers`
- `mesh-class-checkin:room`
